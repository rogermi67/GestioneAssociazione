...
ALTER TABLE users ALTER COLUMN ultimo_accesso TYPE timestamp without time zone;

ALTER TABLE users ALTER COLUMN created_at TYPE timestamp without time zone;

ALTER TABLE soci_cariche ALTER COLUMN data_inizio TYPE timestamp without time zone;

ALTER TABLE soci_cariche ALTER COLUMN data_fine TYPE timestamp without time zone;

ALTER TABLE soci ALTER COLUMN updated_at TYPE timestamp without time zone;

ALTER TABLE soci ALTER COLUMN data_nascita TYPE timestamp without time zone;

ALTER TABLE soci ALTER COLUMN data_iscrizione TYPE timestamp without time zone;

ALTER TABLE soci ALTER COLUMN data_cessazione TYPE timestamp without time zone;

ALTER TABLE soci ALTER COLUMN created_at TYPE timestamp without time zone;

ALTER TABLE riunioni ALTER COLUMN updated_at TYPE timestamp without time zone;

ALTER TABLE riunioni ALTER COLUMN data_riunione TYPE timestamp without time zone;

ALTER TABLE riunioni ALTER COLUMN created_at TYPE timestamp without time zone;

ALTER TABLE partecipazioni_eventi ALTER COLUMN data_iscrizione TYPE timestamp without time zone;

ALTER TABLE notifiche ALTER COLUMN data_scadenza TYPE timestamp without time zone;

ALTER TABLE notifiche ALTER COLUMN data_lettura TYPE timestamp without time zone;

ALTER TABLE notifiche ALTER COLUMN data_invio TYPE timestamp without time zone;

ALTER TABLE impostazioni ALTER COLUMN updated_at TYPE timestamp without time zone;

ALTER TABLE eventi ALTER COLUMN updated_at TYPE timestamp without time zone;

ALTER TABLE eventi ALTER COLUMN data_inizio TYPE timestamp without time zone;

ALTER TABLE eventi ALTER COLUMN data_fine TYPE timestamp without time zone;

ALTER TABLE eventi ALTER COLUMN created_at TYPE timestamp without time zone;

ALTER TABLE documenti ALTER COLUMN data_scadenza TYPE timestamp without time zone;

ALTER TABLE documenti ALTER COLUMN data_caricamento TYPE timestamp without time zone;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260107110141_AddPushSubscriptions', '8.0.0');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260107110541_AddPushSubscription', '8.0.0');
